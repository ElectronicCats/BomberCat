...
void seekTrack2() {
  ...
  Serial.print("apdus: ");
  Serial.print(getHexRepresentation(apdus[0], apdusLen[0]));
  Serial.print(" ");
  Serial.print(getHexRepresentation(apdus[1], apdusLen[1]));
  Serial.print(" ");
  Serial.print(getHexRepresentation(apdus[2], apdusLen[2]));
  Serial.print(" ");
  Serial.println(getHexRepresentation(apdus[3], apdusLen[3]));
