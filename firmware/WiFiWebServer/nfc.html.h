                ...
                <section class="nfc">
                    <div class="nfc-container">
                        ...
                        <form action="#" class="read-form">
                            <input type="number" id="card-number" placeholder="NFCID will appear here"
                                class="inputC text-card" readonly>
                            <input type="number" id="card-date" placeholder="SENS RES will appear here"
                                class="inputC text-date" readonly>
                            <input type="number" id="card-code" placeholder="SEL RES will appear here"
